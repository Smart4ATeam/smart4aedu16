  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <p className="text-sm text-muted-foreground mt-1">全域行事曆、任務選項與系統組態管理</p>
      </motion.div>

      <Tabs defaultValue="calendar" className="space-y-4">
        <TabsList>
          <TabsTrigger value="calendar">全域行事曆</TabsTrigger>
          <TabsTrigger value="task-options">任務選項</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="task-options">
          <TaskOptionsManager />
        </TabsContent>
      </Tabs>
    </div>
